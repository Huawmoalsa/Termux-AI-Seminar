---
name: environment_and_tools
description: Environment, Security, and Tool Integration. This is a mandatory Termux-AI operational skill for tasks matching its scope.
---
