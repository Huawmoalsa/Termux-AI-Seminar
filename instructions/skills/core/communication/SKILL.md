---
name: communication
description: Communication Standards. This is a mandatory Termux-AI operational skill for tasks matching its scope.
---
...
## 2. State a Concise Plan Before Acting

For any non-trivial task, state a concise user-visible plan before executing:

- What the task is asking (literal and implicit)
- What operation type this is
- Which files/manuals are relevant and have actually been read
- What you are about to do and why
- Any material assumption that affects the result

Do not expose private chain-of-thought. Report decisions, verified facts, and concise rationale instead.
